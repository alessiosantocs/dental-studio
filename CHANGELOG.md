### [HTML5 Blank](http://woopstrapblank.com) Changelog
...
* Added WAI-ARIA landmark roles to enrich semantics and improve accessibility. [Stacey Cordoni](https://github.com/staceycordoni) [#32](https://github.com/toddmotto/woopstrapblank/pull/32)
...
* Separated WordPress script enqueue to load Conditionizr, Modernizr in head: 'function woopstrapblank_header_scripts()'
* Hard-coded jQuery and CDN fallback into footer.php above custom theme scripts, more reliable fallback method
* Load custom theme scripts in footer: 'function woopstrapblank_footer_scripts()'
...
* Custom Comments callback - wp_list_comments('type=comment&callback=woopstrapblankcomments'); editable comments now in functions.php
...
* Move toddmotto.com/woopstrapblank/ to new woopstrapblank.com domain
